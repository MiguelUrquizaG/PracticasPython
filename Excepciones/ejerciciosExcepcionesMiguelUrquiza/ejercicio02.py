...
class costeDiarioInferiorCero(Exception):
    def __init__(self,message):
        super().__init__(message)
    
class diasAnyoNoValidos(Exception):
    def __init__(self, message):
        super().__init__(message)
...
try:
    ...
    class Animal:
        ...
        def calcular_coste(self,dias_anyo=365,coste_comida_especial=100,coste_insectos=10)->float:
            ...
            if self.coste_diario<=0:
                raise costeDiarioInferiorCero('No se puede calcular un coste mientras el coste diario sea menor o igual que 0')
            elif dias_anyo !=365 and dias_anyo!=366:
                raise diasAnyoNoValidos('Un año no puede tener un número de días distinto a 365 o 366')
    ...
    print('Hubo un problema al ejecutar el programa')